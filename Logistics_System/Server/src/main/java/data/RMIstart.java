...
import dataImpl.receiver.ReceiverDataImpl;
...
public class RMIstart {
	...
	public static void init(){
		...
		try {
			...
			ReceiverDataService ReceiverDataImpl=new ReceiverDataImpl();
			...
			Naming.rebind("rmi://"+IP+":"+PORT+"/ReceiverDataService", ReceiverDataImpl);

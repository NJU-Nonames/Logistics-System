...
public class CostManage extends JPanel{
	...
	public CostManage(FinacialStaffLowFrame frame, CostManagementBLService bl, CurrentUser currentUser){
		this.frame=frame;
		this.bl=bl;

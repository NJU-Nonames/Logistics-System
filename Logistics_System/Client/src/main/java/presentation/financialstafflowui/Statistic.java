...
public class Statistic extends JPanel{
	...
	public Statistic(FinacialStaffLowFrame frame, FormBLService bl, CurrentUser currentUser){
		this.frame=frame;
		this.bl=bl;
	...
	private void initComponent() {
    	...
    	search2 = new MyButton(30, 30, Img.SEARCH_0, Img.SEARCH_1, Img.SEARCH_2);
